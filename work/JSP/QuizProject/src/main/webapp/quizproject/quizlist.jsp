...
//페이지에서 보여질 글만 가져오기
List<QuizProjectDto> list = dao.getPagingList(startNum, perPage);
%>
<body>
	<div style="margin: 32px 245px; width: 800px;">
		...
		<table class="table">
			<tr>
				<td align="center" style="width: 100px;"><%=dto.getQ_num()%></td>
				<td align="center" style="width: 180px;"><img
					src="<%=dto.getImgname()%>" width="50px;" height="50px;"
					style="border-radius: 20px; border: 1px solid gray;">
					&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="detailview.jsp?num=<%=dto.getQ_num()%>"> <%=dto.getTitle()%></a></td>
		...
		<div>
			<ul class="pagination justify-content-center">
				...
				<li style="margin-left: 264px;" class="page-item"><a
					class="page-link"
					href="quizlist.jsp?currentPage=<%=currentPage - 1%>">이전</a></li>
				<%
				...
				<li class="page-item"><a class="page-link"
					href="quizlist.jsp?currentPage=<%=pp%>"><%=pp%></a></li>
				<%
				}
				}
				%>
				<li class="page-item"><a class="page-link"
					href="quizlist.jsp?currentPage=<%=currentPage + 1%>">다음</a></li>

				<button type="button" class="btn btn-outline-danger"
					style="margin-left: 70px;" onclick="location.href='quizform.jsp'">
					<i class="bi bi-pencil">글쓰기</i>
				</button>
				<button type="button" class="btn btn-outline-success"
					style="margin-left: 5px;" onclick="location.href='quizimglist.jsp'">
					<i class="bi bi-image">이미지 목록</i>
			</ul>
		</div>
